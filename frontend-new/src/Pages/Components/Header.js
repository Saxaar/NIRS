    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <TheaterComedy sx={{ display: { xs: 'none', md: 'flex' }, mr: 3 }} />
          ...
          <TheaterComedy sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {settings.map((setting, index) => (
                <Link to={settingsLinks[index]} style={{ textDecoration: 'none', color: 'black' }}>
